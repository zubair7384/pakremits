...
These marks are stored locally so comparison rows do not depend on third-party image hosting.

- `wise.png` — Wise arrow mark, downloaded from the official [Wise newsroom logo media kit](https://newsroom.wise.com/en-NAM/assets/228784/) on 15 September 2026.
